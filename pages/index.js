      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className=" min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons dark:text-teal-200">
              developed by Andrew
            </h1>
            <ul className="flex items-center">
              <li>
                <BsFillMoonStarsFill
                  className="cursor-pointer text-2xl dark:text-teal-200"
          ...
          <div className="text-center p-10">
            ...
            <h3 className="text-2xl py-2 md:text-3xl dark:text-teal-100">
              Developer
            </h3>
            <p className="capitalize text-md leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-teal-200">
        ...
        <section className="">
          <div className="">
            <h3 className="text-3xl py-1 capitalize dark:text-teal-300">
              services i offer
            </h3>
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <h4 className="capitalize py-4 text-teal-600">
                design tools i use
              </h4>
